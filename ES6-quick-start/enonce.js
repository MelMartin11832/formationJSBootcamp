...
const addId = players.map((x, i) => ({ ...x, identifiant: i }));
console.log("Ex1 : ", addId);

// Ex 2 : Retourner le nom d'un joueur en fonction de son numero de jouer, 'NOT_EXIST' sinon
const numPlayer = numeroDuJoueur => players.find(joueur => joueur.number === numeroDuJoueur);
